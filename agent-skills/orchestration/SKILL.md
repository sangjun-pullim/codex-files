---
name: "orchestration"
description: "Orca orchestration layer for supervised multi-agent coordination \u2014 task DAGs, dispatch --inject, worker_done/escalation waits, decision gates, ask/reply flows. Use ONLY when the user explicitly asks for Orca orchestration or supervised coordination (supervise, monitor, wait for worker_done, DAG, decision gate). Plain Orca worktree/terminal control belongs to `orca-cli`; generic delegation/handoff requests trigger neither skill."
---
